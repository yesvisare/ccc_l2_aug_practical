"""
FastAPI wrapper for Module 7.4: Intelligent Alerting.
...
app = FastAPI(
    title="Intelligent Alerting API",
    description="Module 7.4: Statistical anomaly detection and alert management",
    version="1.0.0"
)
...
@app.post("/alerts/aggregate", response_model=AggregateResponse)
...
@app.post("/runbook/execute", response_model=RunbookResponse)
